...
// 🎯 Async handler for Retell agent creation
const handleCreateWebCall = async (req: Request, res: Response) => {
  try {
...
// ✅ Wrapper to avoid TS2769 error
app.post('/api/create-web-call', (req: Request, res: Response) => {
  handleCreateWebCall(req, res).catch((err) => {
    console.error('❌ Unhandled error in /api/create-web-call:', err);
